...
- SQLite (apenas insert): [SqliteBulkInserter](file:///c:/Projetos/LLServTec/LLS.EFBulkExtensions/src/LLS.EFBulkExtensions/Providers/Sqlite/SqliteBulkInserter.cs)
